...
BASE_DIR='D:\Chrome Downloads\dog_unknown'
BASE_DIR2='D:\Chrome Downloads\dog_unknown2/Dog1'
BASE_DIR3='D:\Chrome Downloads\dog_unknown2/unkown1'
#BASE_DIR='D:\Chrome Downloads\test'
#BASE_DIR='D:\Chrome Downloads\test'
...
def main(argv):
  ...
  y_pred1 = np.argmax(model.predict(val_generator1), axis=1)
  

  
 
  print(y_pred1)
  y_pred2 = np.argmax(model.predict(val_generator2), axis=1)
  print (y_pred2)
